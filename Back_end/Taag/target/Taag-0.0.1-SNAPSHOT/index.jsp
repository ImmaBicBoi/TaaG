...
<html>
            ...
            $(function(){                
                $("#postPerson, #postMessage").on("click", function(){
                    $.ajax({
                        ...
                        type: "POST",
                        data: '{"name":"Soft","parent_position_id":"1","person_id":"3","employee_id": "A11-11","attributes":[{"key":"Type","value":"Part Time"},{"key":"Test2","value":"TestVal2"}]}',
	...
	<body>
	   ...
	   <ul>
	       ...
	       <li><a href="<%=request.getContextPath() %>/service/position"><%=request.getContextPath() %>/service/person/get</a></li>
